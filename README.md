...
* ~~[LambStatus](https://lambstatus.github.io/)~~ *(Discontinued / Un-Supported)*
* [LIVCK](https://livck.com/r/ivbeg) - Free and Self-Hosted Statuspage with built-in Monitoring for Servers, SSL-Certificates, Websites, APIs, Cronjobs (Heartbeat) and Manual-Monitors (e.g. Firewall / PSU ...) with a beautiful statuspage layout
